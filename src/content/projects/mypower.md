...
shortText2: 'Social training platform for creating, sharing and completing calisthenics and strength programs.'

link: 'mypower'
type: 'Full-stack'
tech: ['Next.js', 'React', 'TypeScript', 'Prisma', 'PostgreSQL', 'Supabase', 'Tailwind CSS', 'Cypress']
images:
  - src: '00-home-desktop.png'
    alt: 'MyPower home page introducing the social training platform on desktop'
